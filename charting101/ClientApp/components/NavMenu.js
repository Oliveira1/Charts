            ...
            React.createElement("div", { className: 'navbar navbar-inverse' },
                React.createElement("div", { className: 'navbar-header' },
                    React.createElement("button", { type: 'button', className: 'navbar-toggle', "data-toggle": 'collapse', "data-target": '.navbar-collapse' },
                        ...
                        React.createElement("span", { className: 'icon-bar' }),
                        React.createElement("span", { className: 'icon-bar' })),
                    React.createElement(Link, { className: 'navbar-brand', to: '/' }, "charting101")),
                    ...
                    React.createElement("ul", { className: 'nav navbar-nav' },
                        ...
                        React.createElement("li", null,
                            React.createElement(NavLink, { to: '/fetchdata', activeClassName: 'active' },
                                ...
                                " Fetch data")),
                        React.createElement("li", null,
                            React.createElement(NavLink, { to: '/fetchtransaction', activeClassName: 'active' },
                                React.createElement("span", { className: 'glyphicon glyphicon-th-list' }),
                                " Fetch Transaction entries")),
                        React.createElement("li", null,
                            React.createElement(NavLink, { to: '/helloWorld', activeClassName: 'active' },
                                React.createElement("span", { className: 'glyphicon glyphicon-th-list' }),
                                " My Hello World")),
                        React.createElement("li", null,
                            React.createElement(NavLink, { to: '/chart', activeClassName: 'active' },
                                React.createElement("span", { className: 'glyphicon glyphicon-th-list' }),
                                " Chart")),
                        React.createElement("li", null,
                            React.createElement(NavLink, { to: '/buttons', activeClassName: 'active' },
                                React.createElement("span", { className: 'glyphicon glyphicon-th-list' }),
                                " Chart"))))));
    };
    return NavMenu;
